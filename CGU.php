...
<head>
    <title>CGU HealthyVibe</title>
    <link rel="stylesheet" href="CGU.css">
</head>

<body>
    <h1>POLITIQUE DE CONFIDENTIALITÉ DU SITE OFFICIEL DE HealthyVibe</h1>

    <h2>ARTICLE 1 : PRÉAMBULE</h2>
    <p>
        Cette politique de confidentialité s'applique au site : HealthyVibe. <br>
    ...
    <p>
        Les données à caractère personnel collectées sur le site <strong>Healthy Vibe</strong> sont les suivantes
        <ul>
            <li>Nom, Prénom</li>
        ...
        <br>La collecte et le traitement des données répondent aux finalités suivantes : 
        <ul>
            <li>Etablissement de statistiques pour que le client puisse consulter son activité en moyenne</li>
            <li>Etablissement de statistiques, tout en respectant l'anonymat du client Les traitements de données effectués sont fondés sur les bases légales du consentement de l'utilisateur</li>
        </ul>
    ...
    <p>
        Le site Healthy Vibe est hébergé par : Infinite Measures, <br>
        Dont le siège est situé à l'adresse ci-après : 10 Rue de Vanves, 92130<br>
        L'hébergeur peut être contacté au numéro de téléphone suivant : +33 7 49 11 87 88.<br>
        Les données collectées et traitées par le site sont exclusivement hébergées et traitées en France.<br>
    </p>

    <h2>ARTICLE 4 : RESPONSABLE DU TRAITEMENT DES DONNÉES</h2>
    <h3>A. LE RESPONSABLE DU TRAITEMENT DES DONNÉES</h3>
    <p>Le responsable du traitement des données à caractère personnel est : Maxence GUEGUEN.
        Il peut être contacté par mail à l'adresse suivante : <email>maxence.gueguen@eleve.isep.fr</email>
   ...
   <h3>A. PRÉSENTATION DES DROITS DE L'UTILISATEUR EN MATIÈRE DE COLLECTE ET TRAITEMENT DE DONNÉES</h3>
    ...
    <p>
        ...
        <br><br>S'il en possède un, l'utilisateur a le droit de demander la suppression de son espace personnel en suivant, contactez nous via le site.    
    </p>
    ...
    <p>
        La présente politique de confidentialité peut être consultée à tout moment sur le site officiel de HealthyVibe. <br>
        L'éditeur du site se réserve le droit de la modifier afin de garantir sa conformité avec le droit en vigueur. Par conséquent, l'utilisateur est invité à venir consulter régulièrement cette politique de confidentialité afin de se tenir informé des derniers changements qui lui seront apportés.<br>
        Il est porté à la connaissance de l'utilisateur que la dernière mise à jour de la présente politique de confidentialité est intervenue le : <date>25/10/2022</date>.
    </p>
