...
CREATE USER IF NOT EXISTS 'Admin'@'localhost:8888' IDENTIFIED BY 'admin';
GRANT CREATE, ALTER, DROP, INSERT, UPDATE, DELETE, SELECT ON HealthyVibe.* TO 'Admin'@'localhost:8888';